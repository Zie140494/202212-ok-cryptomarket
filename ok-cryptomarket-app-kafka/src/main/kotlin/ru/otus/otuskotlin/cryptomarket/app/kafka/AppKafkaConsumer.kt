...
interface ConsumerStrategy {
    ...
    fun serialize(source: CpmkContext): String
    fun deserialize(value: String, target: CpmkContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategyCpmk>,
    private val processor: CpmkOrProcessor = CpmkOrProcessor(),
    ...
    private fun sendResponse(context: CpmkContext, strategy: ConsumerStrategy, outputTopic: String) {
